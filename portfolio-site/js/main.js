 ...
 */
      ...
      const projects = [
        ...
        },
        {
          ...
          category: "web",
          images: [
            "assets/img/Ledger1.png",
            "assets/img/Ledger2.png",
            "assets/img/Ledger3.png",
            "assets/img/Ledger4.png",
            "assets/img/Ledger5.png",
            "assets/img/Ledger6.png",
          ],
          title: "Ledger Personal Finance Tracking",
          tags: ["HTML", "CSS", "JavaScript", "Node.JS", "Supabase"],
          desc: "The Ledger Personal Finance tracking website is a web application designed to help users monitor and manage their Finance routines.",
          fullDesc:
